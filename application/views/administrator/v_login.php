...
<html lang="en">
	...
	<body class="m--skin- m-header--fixed m-header--fixed-mobile m-aside-left--enabled m-aside-left--skin-dark m-aside-left--fixed m-aside-left--offcanvas m-footer--push m-aside--offcanvas-default">
		...
		<div class="m-grid m-grid--hor m-grid--root m-page">
			<div class="m-grid__item m-grid__item--fluid m-grid m-grid--hor m-login m-login--signin m-login--2 m-login-2--skin-3" id="m_login" style="background-image: url(<?php echo base_url() ?>assets/metronic/app/media/img//bg/bg-2.jpg);">
				<div class="m-grid__item m-grid__item--fluid	m-login__wrapper">
					<div class="m-login__container">
						<div class="m-login__logo">
							<a href="#">
								<img src="<?php echo base_url() ?>assets/metronic/app/media/img/logos/logo-1.png">
							</a>
						</div>
						<div class="m-login__signin">
							...
							<form method="post" class="m-login__form m-form" action="javascript:void(0);" onsubmit="check_login()" id="form_login">
								...
								<div class="m-login__form-action">
									<button type="submit" id="btn-login" class="btn btn-focus m-btn m-btn--pill m-btn--custom m-btn--air">Sign In Now</button>
								</div>
							</form>
						</div>
						...
						<div class="m-login__forget-password">
							...
							<form class="m-login__form m-form" action="">
								<div class="form-group m-form__group">
									<input class="form-control m-input" type="text" placeholder="Email" name="forgot_email" id="forgot_email" autocomplete="off">
								</div>
								<div class="m-login__form-action">
